...
namespace web
{
    partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
			...
			this.TimesSpan = new System.Windows.Forms.NumericUpDown();
			...
			((System.ComponentModel.ISupportInitialize)(this.TimesSpan)).BeginInit();
			this.SuspendLayout();
			// 
			// web
			// 
			...
			this.panel1.Controls.Add(this.TimesSpan);
			...
			// TimesSpan
			// 
			this.TimesSpan.Location = new System.Drawing.Point(564, 23);
			this.TimesSpan.Maximum = new decimal(new int[] {
            99999999,
            0,
            0,
            0});
			this.TimesSpan.Minimum = new decimal(new int[] {
            1,
            0,
            0,
            0});
			this.TimesSpan.Name = "TimesSpan";
			this.TimesSpan.Size = new System.Drawing.Size(73, 20);
			this.TimesSpan.TabIndex = 6;
			this.TimesSpan.Value = new decimal(new int[] {
            2000,
            0,
            0,
            0});
			...
			((System.ComponentModel.ISupportInitialize)(this.TimesSpan)).EndInit();
        ...
        private Button Stop;
        private Button Run;
		private NumericUpDown TimesSpan;
	}
}
